...
def run_attack():
    ...
    # --- PERFORMANCE NOTE ---
    # The full SQuAD validation set has ~10,000 samples.
    # Running the attack on the full set can take SEVERAL HOURS.
    # 
    # To verify the code works quickly (e.g., in < 5 mins), uncomment the line below:
    # df = df.head(50) 
    # ------------------------
